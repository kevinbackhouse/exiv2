...
ExifData::const_iterator exposureMode(const ExifData& ed) {
  static const char* keys[] = {
      ...
      "Exif.Sony1MltCsA100.ExposureMode", "Exif.Sony1Cs.ExposureProgram",  "Exif.Sony1Cs2.ExposureProgram",
      "Exif.Sony2.ExposureMode",          "Exif.Sony2Cs.ExposureProgram",  "Exif.SonyMisc2b.ExposureProgram",
...
ExifData::const_iterator macroMode(const ExifData& ed) {
  static const char* keys[] = {"Exif.CanonCs.Macro",       "Exif.Fujifilm.Macro",  "Exif.Olympus.Macro",          "Exif.Olympus2.Macro",
...
ExifData::const_iterator imageQuality(const ExifData& ed) {
  static const char* keys[] = {"Exif.CanonCs.Quality",      "Exif.Fujifilm.Quality",      "Exif.Sigma.Quality",
                               ...
                               "Exif.SonyMinolta.Quality",  "Exif.SonyMisc3c.Quality2",   "Exif.Casio.Quality",
...
ExifData::const_iterator whiteBalance(const ExifData& ed) {
  static const char* keys[] = {
      ...
      "Exif.Pentax.WhiteBalance",      "Exif.PentaxDng.WhiteBalance",      "Exif.MinoltaCs5D.WhiteBalance",
      "Exif.MinoltaCs7D.WhiteBalance", "Exif.MinoltaCsNew.WhiteBalance",   "Exif.MinoltaCsOld.WhiteBalance",
      "Exif.Minolta.WhiteBalance",     "Exif.Sony1MltCsA100.WhiteBalance", "Exif.SonyMinolta.WhiteBalance",
      "Exif.Sony1.WhiteBalance",       "Exif.Sony2.WhiteBalance",          "Exif.Sony1.WhiteBalance2",
      "Exif.Sony2.WhiteBalance2",      "Exif.Casio.WhiteBalance",          "Exif.Casio2.WhiteBalance",
      "Exif.Casio2.WhiteBalance2",     "Exif.Photo.WhiteBalance"};
  return findMetadatum(ed, keys, std::size(keys));
}

ExifData::const_iterator lensName(const ExifData& ed) {
  static const char* keys[] = {"Exif.CanonCs.LensType",      "Exif.Photo.LensModel",       "Exif.Canon.LensModel",
                               "Exif.NikonLd1.LensIDNumber", "Exif.NikonLd2.LensIDNumber", "Exif.NikonLd3.LensIDNumber",
                               "Exif.NikonLd4.LensID",       "Exif.NikonLd4.LensIDNumber", "Exif.Pentax.LensType",
...
ExifData::const_iterator saturation(const ExifData& ed) {
  static const char* keys[] = {
      ...
      "Exif.Sigma.Saturation",        "Exif.Casio.Saturation",       "Exif.Casio2.Saturation",
...
ExifData::const_iterator meteringMode(const ExifData& ed) {
  static const char* keys[] = {"Exif.Photo.MeteringMode",       "Exif.Image.MeteringMode",        "Exif.CanonCs.MeteringMode",
                               ...
                               "Exif.Sony1Cs.MeteringMode",     "Exif.Sony1Cs2.MeteringMode",     "Exif.Sony1MltCsA100.MeteringMode",
...
ExifData::const_iterator flash(const ExifData& ed) {
  static const char* keys[] = {"Exif.Photo.Flash", "Exif.Image.Flash", "Exif.Pentax.Flash", "Exif.PentaxDng.Flash"};
  return findMetadatum(ed, keys, std::size(keys));
}
...
ExifData::const_iterator serialNumber(const ExifData& ed) {
  static const char* keys[] = {
      ...
      "Exif.PentaxDng.SerialNumber",   "Exif.Sigma.SerialNumber"};
  return findMetadatum(ed, keys, std::size(keys));
}
